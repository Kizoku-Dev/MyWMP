...
namespace MyWMPv2.View
{
    ...
    public partial class ApplicationView : Window
    {
        ...
        {
            _applicationViewModel.HomeViewModel.ListView_AddPlaylist(sender, e, Media, TreePlaylist, ListMusic, _applicationViewModel.TE.FgList, false);
        }
        private void ListVideo_AddPlaylist(object sender, RoutedEventArgs e)
        {
            _applicationViewModel.HomeViewModel.ListView_AddPlaylist(sender, e, Media, TreePlaylist, ListVideo, _applicationViewModel.TE.FgList, false);
        }
        private void ListImage_AddPlaylist(object sender, RoutedEventArgs e)
        {
            _applicationViewModel.HomeViewModel.ListView_AddPlaylist(sender, e, Media, TreePlaylist, ListImage, _applicationViewModel.TE.FgList, true);
        }
        ...
        {
            _applicationViewModel.HomeViewModel.Playlist_Start(sender, e, TreePlaylist, false);
        }
